...
SECRET_KEY = '+gz4(xdnv8ktgv*rl!+*qaojyuir!+t(_!mkj506^1$p8a&yum'
...
LOGIN_REDIRECT_URL = reverse_lazy('survey:survey_list')
LOGOUT_REDIRECT_URL = reverse_lazy('survey:survey_list')
